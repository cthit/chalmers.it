...
async function main() {
    ...
    data: {
      ...
      NavbarItem: {
        create: [
          ...
          { nameSv: "Verksamhetsdokument", nameEn: "Operational documents", url: "/documents", priority: 50 },
          { nameSv: "Styrdokument", nameEn: "Regulatory documents", url: "/documents", priority: 40 },
          { nameSv: "Programledningen", nameEn: "Programme Management Team", url: "/pages", priority: 30 },
          { nameSv: "SAMO", nameEn: "SAMO", url: "/pages", priority: 20 },
          { nameSv: "Hedersmedlemmar", nameEn: "Honorary Members", url: "/pages", priority: 10 },
        ],
      },
    },
  });
  ...
  await prisma.navbarCategory.create({
    data: {
      ...
      NavbarItem: {
        create: [
          { nameSv: "Boka grupprum", nameEn: "Book a group room", url: "https://cloud.timeedit.net/chalmers/web/b1/", priority: 50 },
          { nameSv: "Studenthälsan", nameEn: "Student Health", url: "https://www.chalmers.se/utbildning/studentliv/studenthalsa/", priority: 40 },
          { nameSv: "Kurser", nameEn: "Courses", url: "https://www.student.chalmers.se/sp/programplan?program_id=2321", priority: 30 },
          { nameSv: "Schema", nameEn: "Schedule", url: "https://cloud.timeedit.net/chalmers/web/public/", priority: 20 },
          { nameSv: "Slack", nameEn: "Slack", url: "https://chalmers-it.slack.com", priority: 10 },
        ],
      },
    },
  });
  ...
  await prisma.navbarCategory.create({
    data: {
      ...
      NavbarItem: {
        create: [
          { nameSv: "HubbIT", nameEn: "HubbIT", url: "https://hubbit.chalmers.it", priority: 70 },
          { nameSv: "Bilder", nameEn: "Pictures", url: "https://pic.chalmers.it", priority: 60 },
          { nameSv: "FindIT", nameEn: "FindIT", url: "https://findit.chalmers.it", priority: 50 },
          { nameSv: "Dokument", nameEn: "Documents", url: "/documents", priority: 40 },
          { nameSv: "Wiki", nameEn: "Wiki", url: "https://wiki.chalmers.it", priority: 30 },
          { nameSv: "Merch", nameEn: "Merch", url: "https://merch.chalmers.it", priority: 20 },
          { nameSv: "Gamma", nameEn: "Gamma", url: "https://gamma.chalmers.it", priority: 10 },
        ],
      },
    },
  });
  ...
  await prisma.navbarCategory.create({
    data: {
      ...
      NavbarItem: {
        create: [
          { nameSv: "ArmIT", nameEn: "ArmIT", url: "https://armit.chalmers.it", priority: 20 },
          { nameSv: "Våra Tjänster", nameEn: "Our Services", url: "/pages", priority: 10 },
        ],
      },
    },
  });
